<!-- SPECKIT START -->
Active feature: **Real Ledger Flex Signing** (`specs/004-real-flex-signing/`).
For technologies, project structure, and the implementation approach, read the
current plan: `specs/004-real-flex-signing/plan.md` (with `research.md`,
`data-model.md`, `contracts/`, and `quickstart.md` alongside it). Implements the
real-device side of the `ApprovalSigner` seam from `003-ledger-simulator-signing`;
builds on `001`/`002`. Note: `003` US2/US3 still deferred.
<!-- SPECKIT END -->
